...
@Tag(tags = "Doctor Controller",
    name = "API methods to work with doctors")
public class DoctorController {
    ...
    public DoctorDto getDoctor(@PathVariable Long id) throws EntityNotExistsException {
    ...
    public void fireDoctor(@PathVariable Long id) throws EntityNotExistsException {
