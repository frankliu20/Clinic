...
public class PatientController {
    ...
    public PatientDto getPatient(@PathVariable Long id) throws EntityNotExistsException {
    ...
    public void removePatient(@PathVariable Long id) throws EntityNotExistsException {
